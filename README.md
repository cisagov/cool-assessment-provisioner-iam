...
```hcl
module "example" {
  source = "github.com/cisagov/cool-assessment-provisioner-iam"
...
- [Deploying into the default VPC](https://github.com/cisagov/cool-assessment-provisioner-iam/tree/develop/examples/default_vpc)
